  ...
  async function handleLogin(e) {
    ...
    toast.promise(
      loginPromise,
      {
        ...
        error: {
          render({ data }) {
            return data || "Invalid email or password";
          },
        },
      },
      {
      ...
      <div className="w-1/2 flex justify-center items-center bg-white">
        <div className="flex flex-col bg-white">
          ...
          <form className="flex flex-col">
            ...
            <ShowPassword mx={"mx-6"} ref={passwordRef} placeholder="Password" />

            <button
              className="mt-8 w-64 mx-6 bg-teal-700 shadow-lg shadow-gray-500/50 text-sm text-white rounded-sm py-1 mb-1.5 hover:bg-teal-600 transition cursor-pointer"
              onClick={handleLogin}
            >
              Log In
            </button>
